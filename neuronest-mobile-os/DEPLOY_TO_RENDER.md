# Deploy NeuroNest Mobile OS On Render
...
1. Create a GitHub repo, for example `neuronest-mobile-os`.
2. Upload the contents of `neuronest-mobile-os`.
...
public/assets/neuronest-ai-avatar.png
```
...
`NEURONEST_API_BASE_URL` is important. It connects mobile to the same PC NeuroNest backend used by Super Admin, so mobile memories, chats, voice notes, screenshots, relationship intelligence, predictions, and Life OS records all sync through the same data layer.
...
```text
https://neuronest-mobile-os.onrender.com
```
...
```text
https://neuronest-mobile-os.onrender.com
https://your-main-neuronest-app.onrender.com
```
