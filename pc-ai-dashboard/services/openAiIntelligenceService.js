...
export async function generateOpenAiIntelligenceReply({ message, language, memoryContext, intelligenceCore }) {
  ...
  const system = [
    ...
    "When memoryTimeMachine context is present, use it for period reconstruction questions. Summarize only real events, people, places, screenshots, voice notes, goals, and timeline evidence. If empty, say no real memories were found.",
